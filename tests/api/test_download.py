...
class TestDownloadEndpoint:
    ...
    @patch("src.downloader.api.get_client")
    def test_download_client_errors(self, mock_get_client, error, expected_status, expected_error_type):
        mock_client = AsyncMock()
    ...
    def test_download_no_auth_required(self, mock_http_client):
    ...
    def test_download_auth_failed(self, headers, expected_status, expected_error_type):
    ...
    def test_download_auth_valid(self, mock_http_client, headers):
